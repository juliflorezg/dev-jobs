...
function loadInitialJSForEditJP() {
  ...
  createJobPostForm.addEventListener('submit', function (e) {
    ...
    jobPostData = {
      ID: Number(document.getElementById('createJobPostFormJobPostID').value),
      ...
      companyID: Number(document.getElementById('createJobPostFormJobPostCompanyID').value),
      requirements: {
        reqID: Number(document.getElementById('createJobPostFormJobPostReqID').value),
        content: createJobPostFormReqDescription.textContent,
        items: getListItemsTexts('createJobPostFormReqList')
      },
      role: {
        roleID: Number(document.getElementById('createJobPostFormJobPostRoleID').value),
    ...
    const fetchUrl = createJobPostForm.getAttribute('action')
    ...
    fetch(fetchUrl, {
      ...
      .then(html => {
        ...
        if (html) {
          ...
          if (document.title.includes("Edit JobPost")) {
